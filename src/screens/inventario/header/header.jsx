...
export const HeaderInventarioComponent =() => {

    return(
        <>
        <div className="header1">
                <img src="titulo 1.png" alt="Título de la página" className="logo" />
            </div>
            ...
            <div className="header3">
                <div className="searchBox">
                    ...
                    <button className="searchButton" onClick={() => { /* Lógica de búsqueda aquí */ }}>
